...
<script type="text/javascript">
	...
	function checkBuy(){
		...
		var price = document.myform.pay.value
	        ...
	        <div class="col-12">
	            <div class="card">
	                <div class="card-body p-0">
	                    <form action="<%=request.getContextPath()%>/prbuy.pr" method="post" name="myform">
		                    <div class="row p-5">
		                        <div class="col-md-12">
		                            <table class="table">
		                                <thead>

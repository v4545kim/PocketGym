    ...
    <section class="gym-award spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <img src="<%=request.getContextPath() %>/resources/img/award.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="<%=request.getContextPath() %>/resources/img/trainer/about-trainer-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="<%=request.getContextPath() %>/resources/img/trainer/about-trainer-2.jpg" alt="">
                        <div class="trainer-text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="<%=request.getContextPath() %>/resources/img/trainer/about-trainer-3.jpg" alt="">
                        <div class="trainer-text">
                            <h5>Walter Wagner</h5>
